...
<div class="content-wrapper user-detail">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-user-circle-o"></i> <?php echo $title; ?>
        </h1>
    </section>
    <!-- Main content -->
            ...
            <div class="box-body">
                <div class="col-md-12 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-sm-4 control-label">User types</label>
                            <div class="col-sm-7 input-group">
                                <?php echo ucwords(str_replace(',', ', ', $user_detail->user_types)); ?>
                            </div>
                        </div>
                    </div>
