        ...
        <div class="container">
            <form class="form-inline"  action="<?php echo base_url("products/search"); ?>" method="get">
                ...
                <div class="form-group col-4 sm-width-45">
                    <select class="form-control selectpicker select2" data-style="btn-primary">
                ...
                <div class="form-group col-4 sm-width-45">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control location_autocomplete_search_input" name="location" value="" placeholder="Search city name"   autocomplete="off">
                        <input type="hidden" class=" location_autocomplete_id" name="location_id" value="">
                    </div>
