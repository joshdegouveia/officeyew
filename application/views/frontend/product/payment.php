    ...
    <section class="slice">
      <div class="container">
        <div class="row row-grid">
          ...
          <?php } ?>
            <form name="payment" id="payment" action="<?php echo base_url('payment/chargeAmountFromCard'); ?>" method="post">
              <div class="card">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <div class="input-group input-group-merge">
                          <input required name="card_no" id="card_no" type="text" class="form-control" data-mask="0000 0000 0000 0000" placeholder="4789 5697 0541 7546">
