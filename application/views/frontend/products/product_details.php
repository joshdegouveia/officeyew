<!-- Banner start -->
<!--<section class="banner-hold-wrapper bg2" style="display: none;">
                    ...
                    <div class="product_cont_left">
                        ...
                        <div class="product_lft_cont">
                            ...
                            <div class="product_des">
                                ...
                                <?php if ((!empty($product_location)) && (count($product_location) > 0)) { ?>
                                    <div class="prodect_des_info">
                                        <h5>Product Location:</h5>
                                        <p>
                                            <?php
                                            foreach ($product_location as $k => $pLocation) {
                                                ?>
                                                <a href="<?php echo base_url("products/search?location=$pLocation->CITY&location_id=$pLocation->city_id") ?>">
                                                    <?php
                                                    if ($k < (count($product_location) - 1)) {
                                                        echo "$pLocation->CITY, ";
                                                    } else {
                                                        echo $pLocation->CITY;
                                                    }
