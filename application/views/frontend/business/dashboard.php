              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  <a href="javascript:void(0)">
                    <span class="info-box-icon bg-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i></span>
                    <div class="info-box-content">
                      <span class="info-box-text">Most Recent Orders</span>
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  <a href="javascript:void(0)">
                    <span class="info-box-icon bg-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i></span>
                    <div class="info-box-content">
                      <span class="info-box-text">Resellers and Orders</span>
