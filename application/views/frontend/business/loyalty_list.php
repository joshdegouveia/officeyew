            ...
            <table id="list_table" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $row->loyalty_amount; ?></td>
                  <td><?php echo $discount; ?></td>
                  <td><?php echo $row->start_date; ?></td>
                  <td><?php echo $row->expiry_date; ?></td>
                  <td>
                    <a href="<?php echo base_url('business/editloyalty'); ?>?cid=<?php echo $row->id ; ?>">
                      <button type="button" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit</button>
                    </a>
                    <a href="<?php echo base_url('business/delete'); ?>?tp=loyalty&cid=<?php echo $row->id ; ?>" class="rm-data">
