          ...
          <div class="px-4 px-lg-6">
            <div>
              <div class="mb-5 text-center">
                <h6 class="h3">Business Login</h6>
                <p class="text-muted mb-0">Sign in to your business account.</p>
              </div>
              ...
              <form role="form" method="post" id="login_form">
                ...
                <div class="form-group mb-4">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="mb-2">
                      <a href="<?php echo base_url('business/forgotpass'); ?>" class="small text-muted text-underline--dashed border-primary">Lost password?</a>
                    </div>
                  </div>
