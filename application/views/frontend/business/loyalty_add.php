<?php
$name = $total_use = $description = $percentage = $flat_rate = $id = $start_date = $expiry_date = $discount_type = $loyalty_amount = '';
$status = 1;
if (!empty($voucher)) {
  $id = $voucher->id;
  $name = $voucher->name;
  ...
  $loyalty_amount = $voucher->loyalty_amount;
...
?>
<div class="main-content loyalty-add-page" data-product="voucher-info<?php echo $id; ?>">
    ...
    <div class="container">
      <div class="row row-grid">
        <div class="col-lg-12 order-lg-2 bg-white">
          ...
          <?php } ?>
          <form id="loyalty_add_form" method="post" enctype="multipart/form-data">
            <div class="actions-toolbar py-2 mb-4 frm-borderb">
              <div class="delimiter-top text-right">
                ...
                <a href="<?php echo base_url('business/loyalty'); ?>" class="btn btn-info btn-sm">Cancel</a>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="form-control-label">Loyalty Amount More Than</label>
                  <input class="form-control" type="number" name="loyalty_amount" id="loyalty_amount" placeholder="Loyalty amount" value="<?php echo $loyalty_amount; ?>" required>
                </div>
              </div>
            </div>
            <div class="row">
