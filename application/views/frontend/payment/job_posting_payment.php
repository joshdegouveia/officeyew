        ...
        <div class="container">
            <div class="row row-grid">
                <div class="col-lg-8">
                    ...
                    <form name="payment" id="payment" action="<?php echo base_url('payment/jobPostChargeAmountFromCard'); ?>" method="post">
                        <div class="card">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="input-group input-group-merge">
												<input required name="card_no" id="card_no" type="text" class="form-control" data-mask="0000 0000 0000 0000" placeholder="000 0000 0000 0000">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                <input required name="cvc" id="cvc" type="text" class="form-control" data-mask="000" placeholder="000">
                        ...
                        <div class="mt-4 text-right">
                            <a href="<?php echo base_url('subscription-charges'); ?>" class="btn btn-link text-sm text-dark font-weight-bold">Return to subscription</a>
