                        ...
                        <table class="table table-cards align-items-center">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <?php } else if ($user['type'] == SELLER) { ?>
                                    <td>
                                        <span class="client"><?php echo $value->sale_price; ?></span>
                                    </td>
                                    <td>
                                        <span class="value text-sm mb-0"><?php echo $customer_name; ?></span>
                                    </td>
                                    <td>
                                        <span class="value text-sm mb-0"><?php echo $value->email; ?></span>
                                    </td>
                                    <?php } ?>
                                    <td>
