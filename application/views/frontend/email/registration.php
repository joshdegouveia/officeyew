...
//                                    if ($this->commonData['site_setting']->site_logo) {
//                                        $logo = UPLOADPATH . 'default/logo/' . $this->commonData['site_setting']->site_logo;
//                                    }
                                    ?>
                                    <td><a href="<?php echo base_url(); ?>" target="_blank" style="display:grid;"><img src="<?php echo $logo; ?>" width="100%" alt=""/></a></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                            ...
                            <tbody>
                                <tr>
                                    <td align="center" style="padding:20px 30px 0px 30px;font-size:24px;line-height:28px"> <span style="font-family:'Open Sans',sans-serif;font-size:24px;line-height:28px;color:#016e92;font-weight:400">
                                            “Thanks for registering with us.</span> </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="left" style="padding:20px 20px 40px 20px;font-size:16px;line-height:22px">
                                        <span style="font-family:'Open Sans',sans-serif;font-size:16px;line-height:22px;color:#063a7b;font-weight:400">
                                            <span style="font-family:Arial,sans-serif;font-size:20px;line-height:24px">Hi <?php echo ucwords($username); ?>,<br><br></span>
                                            <span style="color:#000000;font-style:normal;font-variant-caps:normal;font-weight:normal;letter-spacing:normal;text-align:-webkit-left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;font-family:Arial,sans-serif;font-size:16px;line-height:18px">We need to verify your email address before you can sign in to <?php echo SITE_NAME; ?>.</span><br><br>
                                            <span style="color:#000000;font-style:normal;font-variant-caps:normal;font-weight:normal;letter-spacing:normal;text-align:-webkit-left;text-indent:0px;text-transform:none;white-space:normal;word-spacing:0px;font-family:Arial,sans-serif;font-size:16px;line-height:18px">Please click on the link below to verify your email address:</span>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" bgcolor="#d5f0f9" style="padding-top: 20px; padding-bottom: 20px;">
                                        <a href="<?php echo $active_link; ?>" style="font-size:16px;font-family:'Open Sans',sans-serif;font-weight:400;color:#ffffff;text-decoration:none;border-radius:3px;padding:10px 55px 10px 55px;border:2px solid #0669d2;display:inline-block; background-color:#0669d2;" target="_blank"><span style="color:#ffffff">Click Here</span> </a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
