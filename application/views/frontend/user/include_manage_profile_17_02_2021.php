...
<div class="regd col-md-12">
    ...
    <form id="edit_profile_form " class="form-horizontal edit_profile_form" method="post">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="selected_profile_city_location_content">
                            ...
                            <?php if (count($la_userLocationData) > 0) { ?>
                                <i><b>Business location : </b></i>
                                <?php
                                foreach ($la_userLocationData as $location) {
                                    ...
                                    <span class="selected_location_span" title="<?= $location->COUNTRY ?>">
                                        ...
                                        <?= $location->CITY ?> <i class="fa fa-times remove_selected_location"></i>
                                    </span>
                                    <?php
                                }
                            }
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="selected_business_services_content">
							<i><b> <?php echo (($user['type'] == 'installer')?'Installation Services':'Interior Design Specialty');?>  : </b></i>
							...
							<div class="input-group show_other" id="something_<?= $service_id ?>" style="margin-top:10px;">
							  ...
							  <div class="input-group-append">
								<span class="input-group-text" id="basic-addon2"><i class="fa fa-times remove_selected_other_service" id="<?= $service_id ?>"></i></span>
							  </div>
							</div>
							<?php
							}
				...
				<div class="row">
					...
					<div class="col-md-6">
						 <select name="years_of_experience" class="years_of_experience form-control">
                            ...
                            <?php for ($i = 1; $i <= 10; $i++) { ?>
                                <option value="<?= $i ?>"  <?php if($i == $experience) echo 'selected="selected"';?>><?= $i ?> Years</option>
                            <?php } ?>   
