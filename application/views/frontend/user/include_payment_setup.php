...
<div class="content_right job_posting_dashboard" style="margin-top:20px;">
					...
					<div class="image-contan" >
						<p style="text-align:center;">
							 <?php
									...
									if (isset($paymentDetailsData->front_file) && $paymentDetailsData->front_file != '') {
				...
				<div class="col-md-6">
					<div class="image-contan">
						...
						<?php
							...
							if (isset($paymentDetailsData->back_file) && $paymentDetailsData->back_file != '') {
		...
		<form id="basicBootstrapForm " class="form-horizontal upload_bank_details_form" action="" method="post">
			<div class="form-group">
				<div class="row">
					<div class="col-md-12">
						<input type="text" class="form-control" name="acc_number" value="<?php echo isset($paymentDetailsData->bank_account_number) && $paymentDetailsData->bank_account_number !== ''?$paymentDetailsData->bank_account_number:
				...
				<div class="row">
					<div class="col-md-12">
						<input type="text" value="<?php echo isset($paymentDetailsData->bank_routing_number) && $paymentDetailsData->bank_routing_number !== ''?$paymentDetailsData->bank_routing_number:
