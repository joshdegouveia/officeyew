<div class="orders-container">
    ...
    <table class="table table-hover custom_developer_table">
        ...
        <tbody>
            <?php if (count($la_subscriptionCharges) == 0) { ?>
                <tr>
                    <td colspan="5" class="no_data_row">No data available!</td>
                </tr>
                <?php
            }
            foreach ($la_subscriptionCharges as $row) {
                $status = $row->status;
    ...
    <!--                    <td class="product_name">
                    ...
                    <td class="order_date" title="<?php echo date("D d M, Y H:i:s", strtotime("+$row->duration_in_days days", strtotime($row->created_at))); ?>">
                        <?php echo date("D M d ", strtotime("+$row->duration_in_days days", strtotime($row->created_at))); ?>
                    </td>
                    ...
                    <td class="payment_status processing">
                        <span class="sell-btn2 view_subscriptionCharges_details_btn" id="<?= $viewBtnId ?>"><i class="fa fa-eye"></i></span>
                    </td>
<!--                            <td class="payment_status processing">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="inner_cont_blog">
                        <p><span>Subscription Category: </span><strong class="cat_name">--</strong></p>
                        <p><span>TXN no: </span><strong class="txn_no">--</strong></p>
                        <p><span>Price: </span><strong class="price">--</strong></p>
                        <p><span>Duration in days: </span><strong  class="duration_in_days">--</strong></p>
                        <p><span>Number of product: </span><strong  class="product_no">--</strong></p>
                        <p><span>Subscribed at: </span><strong  class="created_at">--</strong></p>
                        <p><span>Expired at: </span><strong  class="expired_at">--</strong></p>
        ...
        <div class="pager_content">
            <ul class="pagination justify-content-center">
                ...
                for ($i = 1; $i <= $totalPage; $i++) {
                    ...
                    ?>
                    <li class="page-item <?= $activetab ?>"><a class="page-link" id="<?= $i ?>_subscriptionCharges" ><?= $i; ?></a></li>
                    <?php
                }
