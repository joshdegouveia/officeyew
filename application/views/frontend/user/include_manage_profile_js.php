            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        toaster_msg('success', '<i class="fa fa-check"></i>', 'Profile data has been successfully update.');
                    } else {
...
//            $(".edit_profile_form textarea").prop('readonly', false);
        ...
        $('body').on('click', '.business_installation_services_auto_content .auto_location_service_name', function (e) {
			...
			if(serviceName == 'Other: Explain'){
				...
				appendText = '<span class="selected_service_span">\n\
                    <input type="hidden" class="selected_services_input" name="services_id[]" value="' + thisId + '" readonly="">' + serviceName + '\
                    <i class="fa fa-times remove_selected_service"></i>\n\
                    </span>';
			}
			}
